...
claude-msai-aiden() {
  local claude_bin claude_token_file=/Users/aiden/.claude-accounts/msai-aiden/oauth-token
  ...
  (
    ...
    export CLAUDE_CONFIG_DIR=/Users/aiden/.claude-accounts/msai-aiden
...
codex-az() {
  CODEX_HOME=/Users/aiden/.codex-accounts/az command codex "$@"
}
codex-msai-aiden() {
  CODEX_HOME=/Users/aiden/.codex-accounts/msai-aiden command codex "$@"
}
codex-msai-genman() {
  CODEX_HOME=/Users/aiden/.codex-accounts/msai-genman command codex "$@"
}
# <<< dotfiles codex-homes <<<
